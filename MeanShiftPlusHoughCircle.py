...
def findBalloonCentre(image):
    ...
    circles = cv2.HoughCircles(image2, cv2.HOUGH_GRADIENT, 1,
                               120, param1=100, param2=30, minRadius=60, maxRadius=200)
    if circles is None:
...
def getBalloonImage(image):
    ...
    if balloon == 'BALLOON DETECTION FAILED!':
        ...
        crop = image[balloon[1] - balloon[2]:balloon[1] + balloon[2],
                     balloon[0] - balloon[2]:balloon[0] + balloon[2]]
        return crop
###
